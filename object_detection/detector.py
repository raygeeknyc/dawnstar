...
import sys
import os, signal
Last login: Fri Mar 30 07:07:15 on ttys000
Raymonds-MacBook:~ raymond$ cd Documents/workspace/dawnstar/object_detection/
Raymonds-MacBook:object_detection raymond$ cp classify_video.py x.py
Raymonds-MacBook:object_detection raymond$ vi x.py 
